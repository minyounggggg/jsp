...
<h2 class="text-center">게시판 글쓰기</h2>
	<form name="myform" method="post" action="BoardInputOk.bo">
		<table class="table table-bordered">
			...
			<tr>
				<th>글제목</th>
				<td><input type="text" name="title" id="title" placeholder="글제목을 입력하시오" autofocus required class="form-control"/></td>
			</tr>
			<tr>
				<th>글내용</th>
			...
			<tr>
				<th>공개여부</th>
				<td>
					<input type="radio" name="opanSw" id="opanSw1" value="OK" checked/>공개 &nbsp;
					<input type="radio" name="opanSw" id="opanSw2" value="NO" />비공개
				</td>
			</tr>
			<tr>
