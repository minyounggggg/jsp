...
<div class="container">
	...
	<div>
		...
		<a href="input.do4" class="btn btn-primary mr-3">연습Input</a>
		<a href="update.do4" class="btn btn-info mr-3">연습Update</a>
		<a href="delete.do4" class="btn btn-info mr-3">연습Delete</a>
		<a href="search.do4" class="btn btn-info mr-3">연습Search</a>
	</div>
	<!-- 
	<div>
