...
<jsp:useBean id="vo" class="study.j0426.T02VO" /> <!-- 아이디가 클래스변수, 클래스에 들어가는게 클래스 -->
<!-- 
...
<head>
    ...
    <%-- <jsp:setProperty property="name" name="vo" value="홍길동"/>   <!-- vo.setName("홍길동") --> --%>
    <%-- 
    <jsp:setProperty property="name" name="vo"/>   <!-- 변수명이 같을 때 생략가능 -->
    ...
    <jsp:setProperty property="sci" name="vo"/>  
      --%>
    <jsp:setProperty property="*" name="vo"/>  <!-- 한번에 다 가져옴 -->
</head>
<body>
...
<div class="container">
	<h2>넘어온 값들 ~~</h2>
	<hr/>
	<p>접속 IP : <jsp:getProperty property="hostIp" name="vo"/></p>
